# -*- coding: utf-8 -*-
"""suc_smolagents1.ipynb

Automatically generated by Colab.

Original file is located at
    https://colab.research.google.com/drive/1L3VRNwMKLSKO9gXiSGOEV1BtxHE4v9W_
...
"""Successfully installed ddgs-9.14.4 fake-useragent-2.2.0 markdownify-1.2.3 primp-1.3.1 smolagents-1.26.0 socksio-1.0.0"""
...
# تحميل نموذج محلي (مثلاً Qwen 2.5 7B)
# سيتم استهلاك حوالي 15 جيجا من الـ VRAM
model = TransformersModel(
    model_id="Qwen/Qwen2.5-1.5B-Instruct",
    device_map="auto" # سيقوم تلقائياً بتوزيع النموذج على الكرتين عندك
)
...
# الاتصال بسيرفر llama.cpp المحلي الخاص بك
model = LiteLLMModel(
    model_id="openai/local", # اسم صوري
    api_base="http://localhost:8080/v1", # عنوان السيرفر الذي شغلت فيه llama-server
    api_key="none"
)
...
# تحديد موديل متاح فعلياً على Hugging Face Inference API
...
#!pip install smolagents transformers accelerate torch

from smolagents import CodeAgent, TransformersModel, DuckDuckGoSearchTool

# تحميل نموذج صغير جداً يناسب المعالج ورامات كولاب
model = TransformersModel(
    model_id="Qwen/Qwen2.5-1.5B-Instruct",
    device_map="cpu" # إجبار التشغيل على المعالج
)
...
"""https://huggingface.co/smolagents/SmolVLM2-2.2B-Instruct-Agentic-GUI"""

!pip install num2words



"""شغال وانا الل اوقفته"""

from smolagents import CodeAgent, TransformersModel, DuckDuckGoSearchTool

# لاحظ هنا أننا نستخدم TransformersModel مباشرة لأنه الموديل الرسمي
model = TransformersModel(model_id="smolagents/SmolVLM2-2.2B-Instruct-Agentic-GUI")
...
# الموديل الآن يمكنه "رؤية" الصور لو أردت!
result = agent.run("ما هو سعر سهم إنفيديا اليوم؟")
print(result)